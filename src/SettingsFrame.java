...
public class SettingsFrame extends Frame implements ActionListener{
    ...
    public void init(){
        ...
        selectBtn = new MyButton ("images/selectButton.png", 300, 243, 300, 90);
        selectBtn.addActionListener(this);
        
        setBtn = new MyButton ("images/setButton.png", 975, 200, 300, 90);
        setBtn.addActionListener(this);
        
        prevBtn = new MyButton ("images/previewButton.png", 975, 310, 300, 90);
        prevBtn.addActionListener(this);
        
        doneBtn = new MyButton ("images/doneButton.png", 374, 600, 300, 90);
        doneBtn.addActionListener(this);
        
        backBtn = new MyButton ("images/backButton.png", 694, 600, 300, 90);
