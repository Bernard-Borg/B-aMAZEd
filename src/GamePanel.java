...
public class GamePanel extends Panel implements KeyListener{
    ...
    public GamePanel (PlayFrame o, Player p, ArrayList <Question> qList, ArrayList <Level> lList){
        ...
        tempEmpty = new Tile ("images/emptyNode.png");
        tempEnd = new Tile ("images/endPoint.png");
        tempChest = new Tile ("images/chest.png");
        tempWall = new Tile ("images/wall.png");
        ...
        switch (character){
            case 1: chosenCharacter = ("images/yellow.png"); break;
            case 2: chosenCharacter = ("images/purple.png"); break;
            case 3: chosenCharacter = ("images/orange.png"); break;
            case 4: chosenCharacter = ("images/brown.png"); break;
        }
