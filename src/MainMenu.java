...
public class MainMenu extends Frame implements ActionListener{
    ...
    public void init(){
        playBtn = new MyButton ("images/playButton.png", 535, 235, 300, 90);
        playBtn.addActionListener (this);

        newBtn = new MyButton ("images/newPlayerButton.png", 535, 335, 300, 90);
        newBtn.addActionListener (this);

        loadBtn = new MyButton ("images/loadPlayerButton.png", 535, 435, 300, 90);
        loadBtn.addActionListener (this);

        helpBtn = new MyButton ("images/helpButton.png", 1303, 35, 50, 50);
        helpBtn.addActionListener (this);

        settBtn = new MyButton ("images/settingsButton.png", 1303, 95, 50, 50);
        settBtn.addActionListener (this);

        deleteBtn = new MyButton ("images/deleteButton.png", 535, 535, 300, 90);
        deleteBtn.addActionListener(this);

        saveBtn = new MyButton ("images/saveButton.png", 1303, 155, 50, 50);
        saveBtn.addActionListener(this);

        leadBtn = new MyButton ("images/leaderboardButton.png", 1303, 215, 50, 50);
        leadBtn.addActionListener(this);

        exitBtn = new MyButton ("images/exitButton.png", 535, 635, 300, 90);
    ...
    public void paint (Graphics g){
        ...
        try {
            titleImg = ImageIO.read(new  File("images/title.png"));
        }
        catch (Exception e) {
