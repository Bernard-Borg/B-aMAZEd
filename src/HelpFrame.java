...
public class HelpFrame extends Frame implements ActionListener{
    ...
    public void init(){
        imgLbl = new MyLabel ("images/defaultImg.png", 10, 10, 1346, 623);
        ...
        goBtn = new MyButton ("images/goButton.png", 533, 643, 300, 90);
        goBtn.addActionListener(this);
        
        backBtn = new MyButton ("images/backButton.png", 950, 643, 300, 90);
    ...
    public void actionPerformed (ActionEvent e){
        ...
        if (e.getSource()==goBtn){
            ...
            switch(selection){
                case 0: imgLbl.setImage("images/introHelp.png"); break;
                case 1: imgLbl.setImage("images/objectivesHelp.png"); break;
                case 2: imgLbl.setImage("images/chestsHelp.png"); break;
                case 3: imgLbl.setImage("images/settingsHelp.png"); break;
            }
        }
